...
const ItemPage = (props) => {
  ...
  return (
    <div style={{ backgroundColor: "#f7f7f7", padding: "2rem" }}>
      <div className="container-center">
        <div className="item">
          ...
          <div className="item__details">
            ...
            <div>Super Oversized T-shirt With Raw Sleeves In Brown</div>
            <div>$13.99</div>
            <div>Color</div>
            <div>Size</div>
            <div>Quantity</div>
        ...
        <div className="prodrev">
          <div className="prodrev__review">
            ...
            <div className="prodrev__review__comment">
              <div className="prodrev__review__comment-review">asdasdsadas</div>
              <div className="prodrev__review__comment-react">asdsa</div>
            </div>
          </div>
      ...
      <div className="itemsuggest">asds</div>
    </div>
  );
};
